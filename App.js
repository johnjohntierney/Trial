...
function HomeScreen({ navigation }) {
  ...
  return (
    <NativeBaseProvider>
      <Grid>
        <Row>
    <Col style={{alignItems: 'center', justifyContent: 'center', backgroundColor: '#008c45'}}>
    ...
    <Col style={{alignItems: 'center', justifyContent: 'center', padding: 20, backgroundColor: '#cd212a'}}>
        <Input 
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        <Button
          ...
          onPress={() => navigation.navigate('Welcome', {})}block bordered primary></Button>
    </View>
    </Col>
    </Grid>
    </NativeBaseProvider>
...
function WelcomeScreen({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#cd212a' }}>
      <Button
        title="Welcome to Mario's
        We will send updates to { userEmail }"
        onPress={() => navigation.navigate('Welcome', {userEmail: Text, MyName: Text})}block bordered primary>
      </Button>
    </View>
  );
}
